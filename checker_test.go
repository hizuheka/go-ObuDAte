...
func TestProcessor_Run(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			cfg: Config{
				Dir: ".", IDColIdx: 0, InsertF: "INS", UpdateF: "UPD",
				MinID: 2000000000,
			},
			files: map[string]string{
				"INS_01.csv": "ID,Flag\n2000000000,OK\n9999999999,OK",
		...
		},
		{
			...
			cfg: Config{
				Dir: ".", IDColIdx: 0, InsertF: "INS", UpdateF: "UPD", MinID: 200,
			},
			files: map[string]string{
				"INS_01.csv": "ID,Flag\n100,F", // Min未満 -> 再転入エラー
...
func TestProcessor_EdgeCases(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			cfg: Config{
				Dir: ".", IDColIdx: 1, InsertF: "INS", UpdateF: "UPD", MinID: 100,
			},
			files: map[string]string{
				"INS_01.csv": "Flag,ID\nF,200\nT,50",
			},
		...
		},
		{
			...
			expectedOutput: []string{
				...
				"INS_2.csv(2) - エラー対象者の2回目以降 : 100,Third", // 修正: ここが「エラー対象者の2回目以降」になるのが正しい
			},
			expectedStats: Stats{InsertErrors: 2, UpdateErrors: 0},
		},
	}
